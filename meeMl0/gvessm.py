...
class GVESSM(object):
    """GVE state sensitivity matrix for MEEs with mean longitude at epoch.
    ...
    Attributes:
        ...
        vectorize: boolean
            ...
            array is (m, 36, 36), a block diagonal of the (m, 6, 6), which
            allows a vectorized version of Psi to be vector multiplied with it.
